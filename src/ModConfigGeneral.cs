...
namespace MoreImplantSlots
{
    ...
    public class ModConfigGeneral
    {
        ...
        public ModConfigGeneral(string ModName, string ConfigPath)
        {
            ...
            this.ModData.AddConfigValue("general", "Ignore_Implant_Charge_Use", false, "STRING:Implant use consume no Charge", "STRING:Implant charge will not be used upon activation.\n");

            this.ModData.AddConfigValue("general", "about_res", "STRING: Negative % turn malus into bonus upon installation. Below res malus negation apply to the enemies. Choose wisely. <color=#f51b1b>On existing save, existing clone must have new augment/implant installed to have below value updated.</color>\n");
            this.ModData.AddConfigValue("general", "Flat_Res_Malus_Multiplier", 100, -100, 100, "STRING:Flat Res Malus Multiplier %", "STRING:Set % of flat resistance malus from augments/implants. Lowest is -100%, Multiplies with steel within.");
            this.ModData.AddConfigValue("general", "Mult_Res_Malus_Multiplier", 100, -100, 100, "STRING:Mult Res Malus Multiplier %", "STRING:Set % of Percentage based resistance malus from augments/implants..");
            this.ModData.AddConfigValue("general", "Quasigen_Malus_Multiplier", 100, -100, 100, "STRING:Quasimorphosis Gain Multiplier %", "STRING:Set % of Quasimorphosis gain from augments/implants (rounded down).");
